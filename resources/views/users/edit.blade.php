    ...
    <div class="col-md-8">
        ...
        <form action="{{ route('users.update',[$user->id]) }}" method="post" enctype="multipart/form-data" class="bg-white shadow-sm p-3">
            ...
            <input type="hidden" name="_method" value="put">
                ...
                <input type="text" name="name" id="name" class="form-control" placeholder="Full Name" value="{{ $user->name }}"> <br>
                ...
                <input type="text" name="phone" id="phone" class="form-control" value="{{ $user->phone }}"> <br>
